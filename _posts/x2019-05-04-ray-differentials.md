---
title:  "Implementing Ray Differentials"
date:   2022-05-04 10:30
categories: rendering
---

When it comes to anti-aliasing in ray tracing, of the most effective techniques is ray differentials. In this blog post, I'll give an overview of the technique and how to implement it. I'll use a very simple ray tracer example, full source code available, which will use embree so we don't need to worry about performance and so forth.
